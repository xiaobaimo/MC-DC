...
def test(model, path, test_name):
    ...
    for step,(x,y) in enumerate(test_loader):
        ...
        loss = structure_loss(res.sigmoid(), gt)
        #loss = MLoss(res, gt)
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("/datasets/Dset_Jerry/isic18/checkpoint/MC-FuseV3_192_256/MC-Fuse-35.pth"), strict=False)
