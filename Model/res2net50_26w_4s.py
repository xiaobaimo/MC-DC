...
def res2net50_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth = 26, scale = 4, **kwargs)
    if pretrained:
        model.load_state_dict('/datasets/Dset_Jerry/Pre_train/res2net50_26w_4s-06e79181.pth')#(model_zoo.load_url(model_urls['res2net50_26w_4s']))
    return model
...
def res2net50_26w_6s(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict("/datasets/Dset_Jerry/Pre_train/res2net50_26w_6s-19041792.pth")
    return model
...
def res2net50_26w_8s(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict('/datasets/Dset_Jerry/Pre_train/res2net50_26w_8s-2c7c9f12.pth')
    return model
